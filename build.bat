...
echo  ╔══════════════════════════════════════════════════════════════════════╗
echo  ║                                                                    ║
echo  ║         AUDIOCLASS v9.1 — INSTALADOR AUTOMÁTICO               ║
...
if not defined PYTHON_EXE (
    ...
    echo.
    echo   Voy a instalarlo automáticamente con winget...
    echo.
...
if not exist "audioclass_env\Scripts\python.exe" (
    ...
    echo   Ya existia un espacio aislado. Se reutiliza.
)
...
echo.
echo  [3/6]  Instalando las librerías necesarias (puede tardar)...
echo.
...
if errorlevel 1 (
    echo  No se pudo instalar el PyTorch ligero. Se usará el estándar, tarda más.
) else (
    echo  PyTorch ligero listo.
)

echo.
echo   Paso 2 de 2: resto de librerías (Whisper, Gemini, interfaz)...
...
if errorlevel 1 (
    echo  No se pudo descargar el modelo de voz automáticamente.
...
echo.
echo   Si el paso anterior pidió una API Key, puedes añadirla después
...
echo  ║  ¡TODO LISTO!                                                    ║
echo  ║                                                                    ║
echo  ║  La app se está abriendo...                                      ║
echo  ║                                                                    ║
echo  ║  Para abrirla en el futuro:                                        ║
echo  ║     Icono "AudioClass" en tu escritorio                         ║
echo  ║     O "Iniciar AudioClass.bat" en esta carpeta                  ║
echo  ║                                                                    ║
